...
//        System.out.println(Arrays.toString(output));
    ...
    public void testAddConnections() {
        ...
        for (String keyword : keywords) {
            q = new Question(prof, placeHolder, placeHolder, keyword, placeHolder, "q");
            forest.insert(q);
        }
        ...
        output = forest.queryConnection("Tree");
        expected = new String[] {"heap", "bst"};
